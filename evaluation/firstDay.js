...
function calculate(forecast, real) {    // ПРОЦЕНТЫ
    ...
    let wind_speed = 0  // скорость ветра должна отличаться от границ не более, чем на 2 м/с
    ...
    let rainfall = weatherEvent([forecast.snow, forecast.rain, forecast.rainsnow, forecast.mist, forecast.sand, forecast.squall, forecast.storm, forecast.drizzle], [real.snow, real.rain, real.rainsnow, real.mist, real.sand, real.squall, real.storm, real.drizzle])
